...
![]({{ site.qnurl }}/media/qt-installer/ifw-overview.png){:.img-fluid}
...
![]({{ site.qnurl }}/media/qt-installer/ifw-user-flow-installing.png){:.img-fluid}

添加组件，用于在初始安装后添加新的组件（类似于包管理器），包括以下三个流程。

![]({{ site.qnurl }}/media/qt-installer/ifw-user-flow-adding.png){:.img-fluid}

删除组件，用于在删除之前安装的组件，包含以下流程，其中 *Remove* 选项直接删除所有组件。

![]({{ site.qnurl }}/media/qt-installer/ifw-user-flow-removing.png){:.img-fluid}

升级组件，用于从远程仓库获取升级的组件并安装，包括以下三个流程。

![]({{ site.qnurl }}/media/qt-installer/ifw-user-flow-updating.png){:.img-fluid}
